...
internal class WaveProgressGradientOffsetConverter : IValueConverter
{
    ...
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        var primaryColor = (Color)(Application.Current!.FindResource("GlobalPrimaryColor") ?? Colors.DodgerBlue);
        var accentColor = (Color)(Application.Current!.FindResource("GlobalAccentColor") ?? Colors.Transparent);
