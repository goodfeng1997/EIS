...
namespace EIS.Shared.ExpressionToSql.Expressions
{
    ...
    public abstract class BaseExpression<T> : IExpression where T : Expression
    {
        ...
        /// <returns>SqlWrapper</returns>
        public virtual SqlWrapper OrderBy(T expression, SqlWrapper sqlWrapper, params OrderTypeEnum[] orders) =>
        ...
        /// <param name="orders">排序方式</param>
        /// <returns>SqlWrapper</returns>
        public SqlWrapper OrderBy(Expression expression, SqlWrapper sqlWrapper, params OrderTypeEnum[] orders) =>
