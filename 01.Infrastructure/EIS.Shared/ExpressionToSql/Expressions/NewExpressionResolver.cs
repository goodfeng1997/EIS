	...
	public class NewExpressionResolver : BaseExpression<NewExpression>
    {
        ...
        public override SqlWrapper Insert(NewExpression expression, SqlWrapper sqlWrapper)
        {
            ...
            if (sqlWrapper[^1] == ',')
            {
                ...
                sqlWrapper.Append(sqlWrapper.DatabaseTypeEnum != DatabaseTypeEnum.Oracle ? ")" : " FROM DUAL");
            }
        ...
        /// <returns>SqlWrapper</returns>
        public override SqlWrapper OrderBy(NewExpression expression, SqlWrapper sqlWrapper, params OrderTypeEnum[] orders)
        {
