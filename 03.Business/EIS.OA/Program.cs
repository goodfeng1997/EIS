...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.OA.xml");
...
app.UseSwaggerService(builder.Configuration, "oa/{documentName}/swagger.json", "/oa/v1/swagger.json");
