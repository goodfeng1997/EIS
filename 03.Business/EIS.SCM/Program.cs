...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.SCM.xml");
...
app.UseSwaggerService(builder.Configuration, "scm/{documentName}/swagger.json", "/scm/v1/swagger.json");
