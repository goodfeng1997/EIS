...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.BI.xml");
...
app.UseSwaggerService(builder.Configuration, "bi/{documentName}/swagger.json", "/bi/v1/swagger.json");
