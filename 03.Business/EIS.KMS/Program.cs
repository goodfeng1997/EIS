...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.KMS.xml");
...
app.UseSwaggerService(builder.Configuration, "kms/{documentName}/swagger.json", "/kms/v1/swagger.json");
