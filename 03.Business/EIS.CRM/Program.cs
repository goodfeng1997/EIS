...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.CRM.xml");
...
app.UseSwaggerService(builder.Configuration, "crm/{documentName}/swagger.json", "/crm/v1/swagger.json");
