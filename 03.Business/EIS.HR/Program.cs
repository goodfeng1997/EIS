...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.HR.xml");
...
app.UseSwaggerService(builder.Configuration, "hr/{documentName}/swagger.json", "/hr/v1/swagger.json");
