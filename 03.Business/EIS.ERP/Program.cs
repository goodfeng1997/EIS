...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.ERP.xml");
...
app.UseSwaggerService(builder.Configuration, "erp/{documentName}/swagger.json", "/erp/v1/swagger.json");
