...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.ISMS.xml");
...
app.UseSwaggerService(builder.Configuration, "isms/{documentName}/swagger.json", "/isms/v1/swagger.json");
