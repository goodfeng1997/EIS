...
builder.Services.AddSwaggerService(builder.Configuration, "EIS.BackManage.xml");
...
app.UseSwaggerService(builder.Configuration, "back/{documentName}/swagger.json", "/back/v1/swagger.json");
